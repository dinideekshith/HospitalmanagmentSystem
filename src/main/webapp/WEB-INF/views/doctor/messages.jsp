...
<body>
            ...
            <div class="sidebar">
                ...
                <div class="contact-list">
                    ...
                    <c:if test="${empty contacts}">
                        <div style="padding: 1.5rem; color: #A0AEC0;">No contacts available.</div>
                    </c:if>
                </div>
            </div>
    ...
    <script>
        ...
        // Initialize WebSocket Connection globally for this user
        ...
        stompClient.connect({}, function (frame) {
            ...
            stompClient.subscribe('/topic/messages/' + currentUserId, function (messageOutput) {
                ...
                // If the message belongs to the active chat window, display it
        ...
        function openChat(contactId, contactName, contactRole) {
            ...
            chatArea.innerHTML = `
                <div class="chat-header">
                    <div>
                        <h3 style="margin: 0; color: #2D3748;">`+contactName+`</h3>
                        <span class="contact-role">`+contactRole+`</span>
                    </div>
                    <div style="display:flex; gap:0.5rem;">
                        <button onclick="sendMeetLink()" class="btn btn-outline" style="border-color: #4299E1; color: #4299E1; padding: 0.4rem 0.8rem; font-size: 0.8rem;">
                            <i class="fas fa-video"></i> Send Meet Link
                        </button>
        ...
        function appendMessage(message) {
            ...
            // Auto-linkify Google Meet links
        ...
        function sendMeetLink() {
            const meetLink = prompt("Please enter your Google Meet link to send to the patient:");
            if (meetLink && meetLink.trim() !== "") {
                const content = "Please join my video consultation room using this link: " + meetLink;
