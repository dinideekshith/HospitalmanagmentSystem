...
<body>
    ...
    <div class="container dashboard-wrapper">
        <h2 class="text-primary">Registered Patients</h2>
            ...
            <tbody>
                <c:forEach var="patient" items="${patients}">
                    <tr>
                        ...
                        <td>${patient.user.mobileNumber}</td>
                        <td>${patient.bloodGroup != null ? patient.bloodGroup : 'Not Set'}</td>
                        <td>${patient.dateOfBirth != null ? patient.dateOfBirth : 'Not Set'}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
